...
export class HeaderComponent {
   ...
   constructor(public popup: PopupService, public shopping: ShoppingService, public helper: HelperService) {}

   ngOnInit() {
   }

   public toggleSearch = () => document.querySelector('app-main')!.classList.toggle('form-open');

   public toggleSidebar = () => this.helper.sidenavOpen = !this.helper.sidenavOpen;
   ...
   public addAllWishlistToCart = (values:any) => this.shopping.addAllWishListToCart(values);
